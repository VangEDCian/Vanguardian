...
## 0) Tài liệu bắt buộc phải đọc trước khi thực hiện dự án
...
- Django `Form`, `Serializer`, `ViewModel` và các object phục vụ web/API adapter phải nằm trong `presentation/`, không đặt ở app root.
