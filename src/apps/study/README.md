...
Eligibility criteria detail remains CRF/datacapture data. Field-specific inclusion/exclusion mappings must be configured through `datacapture_fact_mapping` or workflow configuration data, not hard-coded into the study domain service.
