    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField()),
                ('deleted', models.BooleanField(default=False)),
                ('control_type', models.CharField(choices=[('TEXT', 'Text'), ('TEXTAREA', 'Textarea'), ('NUMBER', 'Number'), ('SELECT', 'Select'), ('SELECT2', 'Select2'), ('RADIO', 'Radio'), ('CHECKBOX', 'Checkbox'), ('MULTI_SELECT', 'Multi Select'), ('DATE', 'Date'), ('DATE_TEXT', 'Date Text'), ('DATETIME', 'DateTime'), ('DATETIME_TEXT', 'DateTime Text'), ('LABEL_ONLY', 'Label Only')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField()),
                ('deleted', models.BooleanField(default=False)),
                ('rule_type', models.CharField(choices=[('REQUIRED', 'Required'), ('DATA_TYPE', 'Data type'), ('LENGTH', 'Length'), ('NUMERIC_RANGE', 'Numeric range'), ('DATE_RANGE', 'Date range'), ('REGEX', 'Regex'), ('ALLOWED_VALUES', 'Allowed values'), ('FIELD_COMPARE', 'Field compare'), ('CONDITIONAL_REQUIRED', 'Conditional required'), ('CONDITIONAL_ALLOWED', 'Conditional allowed'), ('CALCULATED_VALUE', 'Calculated value'), ('UNIQUE', 'Unique'), ('VISIT_WINDOW', 'Visit window'), ('CUSTOM_EXPRESSION', 'Custom expression')], max_length=64)),
                ('expression', models.TextField()),
                ('severity', models.CharField(max_length=20)),
                ('mode', models.CharField(choices=[('HARD', 'Hard - block save/submit'), ('SOFT', 'Soft - warning with confirmation or reason'), ('QUERY', 'Query - save data and create a data query')], max_length=20)),
                ('created_by_id', models.BigIntegerField(blank=True, null=True)),
                ('updated_by_id', models.BigIntegerField(blank=True, null=True)),
            ],
            options={
