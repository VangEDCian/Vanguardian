...
class CrfFormBuilderAuditService:
    ...
    def record_field_created(self, *, request, study_id, form_id, field_template_id, after_data):
    ...
    def record_field_updated(self, *, request, study_id, form_id, field_template_id, before_data, after_data):
        self.audit_context_adapter.record_event(
    ...
    def record_field_deleted(self, *, request, study_id, form_id, field_template_id, before_data):
        self.audit_context_adapter.record_event(
    ...
    def record_section_template_saved(self, *, request, study_id, form_id, section_object_id, after_data):
        self.audit_context_adapter.record_event(
    ...
    def record_section_template_deleted(self, *, request, study_id, form_id, section_object_id, before_data):
        self.audit_context_adapter.record_event(
    ...
    def record_template_saved(self, *, request, study_id, template_id, after_data):
        self.audit_context_adapter.record_event(
