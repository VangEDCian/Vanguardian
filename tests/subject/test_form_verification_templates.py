...
class FormVerificationTemplateTests(SimpleTestCase):
    ...
    def test_field_review_panel_renders_open_query_and_thread_query_modals(self):
        ...
        self.assertIn("data-query-modal-request-clarification", rendered)
        self.assertIn("data-query-modal-reply-close", rendered)
        self.assertIn("data-query-modal-close-query", rendered)
        self.assertIn("data-query-modal-reopen", rendered)
        self.assertIn("data-query-modal-cancel-query", rendered)
        self.assertIn("data-query-history-modal-reopen", rendered)
        self.assertIn("Answer", rendered)
        self.assertIn("Request Clarification", rendered)
        self.assertIn("Resolve", rendered)
        self.assertIn("Reopen", rendered)
        self.assertIn("Cancel", rendered)
        self.assertIn("Close", rendered)
        self.assertIn("Dismiss", rendered)
